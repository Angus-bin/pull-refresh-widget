...
import com.handmark.pulltorefresh.library.ILoadingLayout2;

@SuppressLint("ViewConstructor")
public abstract class LoadingLayout2 extends FrameLayout implements ILoadingLayout2 {
	 ...
	 * @param attrs attrs
	 */
	public LoadingLayout2(Context context, AttributeSet attrs) {
	 ...
	 */
	public LoadingLayout2(Context context, AttributeSet attrs, int defStyle) {
