 ...
 * @version 1.0
 */
public class PullToRefreshListView1 extends PinnedHeaderListView implements OnScrollListener {  
    ...
    public PullToRefreshListView1(Context context, AttributeSet attrs, int defStyle) {  
    ...
    private void init(Context context) {   
        ...
        headView = (LinearLayout) inflater.inflate(R.layout.kds_news_pull_to_refresh_head, null);  
    ...
    private void changeHeaderViewByState() {  
        ...
        case DONE:  
            ...
            arrowImageView.clearAnimation();  
            // 此处更换图标   
            arrowImageView.setImageResource(R.drawable.kds_news_ic_pulltorefresh_arrow);  
    ...
    public void onRefreshCompleteForDefText() { 
        lastUpdatedTextView.setText(context.getResources().getString(R.string.abs__update_time) + "  "+
        		getDateStr());  
        onRefreshComplete();
    } 
